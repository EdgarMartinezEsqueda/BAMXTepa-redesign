    ...
    >
      ...
      <div className="relative container mx-auto px-4 z-10">
        <div className="max-w-2xl mx-auto">
          ...
          <a href="/programas#voluntariado" className="inline-block bg-rojoLogo hover:bg-orange-600 text-white font-semibold text-lg px-8 py-4 rounded-lg transition-colors duration-300 shadow-lg" >
      ...
      <div className="absolute right-0 top-0 z-0 pointer-events-none">
        <img src="assets/images/cta-shap.svg" alt="" />
      </div>
